...
var viaplayer = {
	...
	player: function(list, api) {
		...
		this.audio = document.getElementById("via-audio"), this.title = document.querySelector(".via-info"), this.viaLrc = document.querySelector(".lrc-content");
		this.viaBarControl = document.querySelector(".bar-control"), this.viaNowtime = document.querySelector(".via-now-time"), this.viaAllTime = document.querySelector(".via-all-time");
